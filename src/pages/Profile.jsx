...
const Profile = () => {
  ...
  return (
    <div className="flex min-h-full justify-center items-center">
      <div
        className={`flex p-5 shadow-gray-400 shadow-lg rounded-lg flex-col gap-4 w-[400px]`}
      >
        <div className={`${isEditing ? 'hidden' : 'flex'} gap-3 flex-col`}>
          ...
          <div className="flex flex-col gap-3">
            <button
              className="p-3 bg-primary text-white rounded-lg hover:cursor-pointer hover:opacity-60"
        ...
        <form
          className={`flex-col gap-3 items-center ${isEditing ? 'flex' : 'hidden'}`}
        >
          ...
          <div className="w-fit flex flex-col gap-4">
            <div className="flex gap-15 items-center">
              ...
              <div
                className="bg-primary px-5 py-2 transition-colors duration-200 rounded-md text-white hover:cursor-pointer hover:opacity-70 active:bg-white"
            ...
            <div className="flex mt-4 justify-end gap-4">
              <div
                className="bg-red-500 px-5 py-2 transition-colors duration-200 rounded-md text-white hover:cursor-pointer hover:opacity-70 active:bg-white"
