...
const Nav = () => {
  ...
  const menuName = sideBarMenu?.filter(
    (side) => location.pathname === side.path
  )[0]?.name
    ...
    <div className="flex h-15 px-3 shadow-gray-500 shadow-xs w-full items-center justify-between">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          <button
            className="hover:cursor-pointer hover:border-1 rounded-full"
          ...
          >
            <Link
              ...
              className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition-colors rounded-t-lg"
            >
              View Profile
            </Link>
            <Link
            ...
            <div className="w-full hover:bg-gray-100 hover:cursor-pointer">
              <button
                ...
                className="w-full text-left px-4 py-2 text-sm text-red-500 transition-colors rounded-b-lg hover:cursor-pointer"
              >
                Logout
              </button>
            </div>
